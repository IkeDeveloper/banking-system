...
class BankingSystemManager:
    ...
    def createBankAccount(self): #Creates a bank accountg
        ...
        while True:
            ...
            self.accounts[new_id] = BankAccount(account_number, firstname, surname, telephoneno, email, address=CustAddress(street_number, street_name, city, postcode, country))
